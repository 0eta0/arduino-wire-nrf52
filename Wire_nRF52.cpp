...
void TwoWire::begin(void) {
  ...
  //Serial.println("This is for nrf52");
  //Master Mode
  master = true;
  //Serial.println("1");
...
// Serial.println("End 4");
  ...
  uint32_t t = micros(); while((micros()-t)<40);
  // while(!_p_twim->EVENTS_LASTTX && !_p_twim->EVENTS_ERROR){
  //   //Serial.println(_p_twim->EVENTS_LASTTX);
  //   //Serial.println(_p_twim->EVENTS_ERROR);
  //   delay(1000);
  // }
